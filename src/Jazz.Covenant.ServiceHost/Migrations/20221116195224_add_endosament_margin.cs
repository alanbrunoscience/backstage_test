...
{
    public partial class add_endosament_margin : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "EndosamentMargin",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EndosamentMargin", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EndosamentMargin_Covenants_CovenantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EndosamentMargin_CovenantId",
                table: "EndosamentMargin",
                column: "CovenantId");
        }
