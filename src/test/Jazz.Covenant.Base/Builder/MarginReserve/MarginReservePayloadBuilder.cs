...
{
    public class MarginReservePayloadBuilder
    {
        private MarginReservePayload _marginReservePayload;

        public MarginReservePayloadBuilder()
        {
            _marginReservePayload = new MarginReservePayload
            {
                Enrollment = "123456",
        ...
        public MarginReservePayloadBuilder WithEnrollment(string enrollment)
        {
            _marginReservePayload.Enrollment = enrollment;
            return this;
        }

        public MarginReservePayload Build()
        {
            return _marginReservePayload;
        }
    }
}