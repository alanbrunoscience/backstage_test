...
public class EndosermentMarginRequestBuilder
{
    private readonly EndosamentMarginDtoRequest _endosamentMarginDtoRequest;

    public EndosermentMarginRequestBuilder()
    {
        _endosamentMarginDtoRequest = new EndosamentMarginDtoRequest
        {
            Enrollment = "123456",
    ...
    public EndosermentMarginRequestBuilder WithEnrollment(string enrollment)
    {
        _endosamentMarginDtoRequest.Enrollment = enrollment;
        return this;
    }

    public EndosamentMarginDtoRequest Build()
    {
        return _endosamentMarginDtoRequest;
    }
}